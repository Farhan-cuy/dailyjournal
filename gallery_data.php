                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                        <img src="img/<?= $row["gambar"] ?>" width="100" data-id="<?php echo $row['id']?>" data-bs-toggle="modal" data-bs-target="#modalDetail<?= $row["id"] ?>">
                                <?php
                                    }
                                }
                                ?>
                                ...
                                <td>
                                    <a href="#" title="edit" class="badge rounded-pill text-bg-success text" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row["id"] ?>"><i class="bi bi-pencil"></i></a>
        ...
        <div class="modal-content">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="formGroupExampleInput2" class="form-label">Ganti Gallery</label>
                        <input type="file" class="form-control" name="gambar">
                    </div>
                    <div class="mb-3">
                        <label for="formGroupExampleInput3" class="form-label">Gallery Lama</label>
                        <?php
                        if ($row["gambar"] != '') {
                            if (file_exists('img/' . $row["gambar"] . '')) {
                        ?>
